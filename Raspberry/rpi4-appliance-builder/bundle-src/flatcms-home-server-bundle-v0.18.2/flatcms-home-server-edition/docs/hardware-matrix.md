...
3. Raspberry Pi 4.
4. Synology DS120 package path.

## Why This Order

The NUC and old PC validate the bootable installer path. Raspberry validates the ARM image path. Synology is a different distribution model and should be isolated from the USB/ISO workflow.
