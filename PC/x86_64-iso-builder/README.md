...
This builder exists for ongoing work, but no x86_64 PC installation image has
been field-tested and approved yet.
...
This artifact must currently be treated as a local experimental output only.
